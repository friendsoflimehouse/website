        ...
        <Stack spacing="8">
          ...
          <Box>
            ...
            <Text pt="2" fontSize="md">
              ...
              As part of the Neighbourhood Forum, there were four personal consultations and a media one with several hundred residents of Limehouse. Most participants emphasized the lack of open spaces — in other words, Green Infrastructure. <Link color="blue.500" href="hhttps://www.ucl.ac.uk/" isExternal>UCL</Link> were invited to find evidence for these results. UCL's <Link color="blue.500" href="https://friendsoflimehouse.com/assets/UCL_GI_Report-f548f68b.pdf" isExternal>
